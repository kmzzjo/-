export interface OrgNode {
  ...
  head?: string;
  role?: string;
  color?: 'blue' | 'yellow' | 'peach' | 'gray' | 'white' | 'light-green' | 'light-blue' | 'purple' | 'orange' | 'dark-gray';
  stackChildren?: boolean;
  invisible?: boolean;
  isInvisible?: boolean;
  invisibleHeight?: string;
  rightBranch?: OrgNode;
  children?: OrgNode[];
  offsetX?: number;
  offsetY?: number;
  ...
  children: [
    {
      ...
      rightBranch: {
        id: "future-strategy", name: "미래전략실", role: "상무", head: "임훈호", color: "blue", stackChildren: true,
        children: [
          { id: "future-strategy-team", name: "미래전략팀", role: "책임", head: "강병호", color: "gray" }
        ]
      },
      children: [
        {
          ...
          rightBranch: {
            id: "ext-support", name: "대외지원TFT", role: "상무", head: "손홍락", color: "blue", offsetX: 185
          },
          children: [
            {
              id: "planning-div", name: "기획본부", role: "전무", head: "정성현", color: "blue",
                      children: [
                        {
                          id: "dummy_planning", name: "", invisible: true,
                          children: [
                    ...
                    },
                    {
                      ...
                      children: [
                        {
                          id: "dummy_management", name: "", invisible: true,
                          children: [
                            {
                    ...
                    },
                    {
                      ...
                      children: [
                        {
                          id: "dummy_sales", name: "", invisible: true,
                          children: [
                            {
                    ...
                    },
                    {
                      ...
                      children: [
                        {
                          id: "dummy_labor", name: "", invisible: true,
                          children: [
                            {
                    ...
                    },
                    {
                      ...
                      children: [
                        {
                          id: "dummy_quality", name: "", invisible: true,
                          children: [
                            {
